...
/**
 * Componente SVG para um ícone de tarefa.
 * @param {React.SVGProps<SVGSVGElement>} props - Propriedades SVG padrão.
 * @returns {JSX.Element} O ícone como um elemento SVG.
 */
export function TaskSquareIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
